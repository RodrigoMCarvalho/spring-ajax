...
public class SocialMetaTagService {
    ...
    public SocialMetaTag getSocialMetaTagByUrl(String url) {
        SocialMetaTag twitter = getTwitterCardByUrl(url);  //primeira opcao de retorno eh o twitter card
        if(!isEmpty(twitter)) {
            return twitter;
        }
        ...
        return null; //se não retornar valores pelo twitter ou openGraph, o retorno será null
    }
